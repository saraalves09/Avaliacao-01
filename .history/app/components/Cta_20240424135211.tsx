...
// Define componente
const Cta = () => {
  //This line utilizes the useState hook to create a state variable named showAlert and a function to update it,
  const [showAlert, setShowAlert] = useState(false);
    //O valor inicial de showAlert is set to false, indicating that the success alert is not visible by default.
